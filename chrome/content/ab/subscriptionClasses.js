...
glome.abp.Subscription = Subscription;
...
SpecialSubscription.prototype =
{
  ...
  get title()
  {
    return glome.getString(this._titleID);
  },
...
glome.abp.SpecialSubscription = SpecialSubscription;
...
glome.abp.RegularSubscription = RegularSubscription;
...
glome.abp.ExternalSubscription = ExternalSubscription;
...
glome.abp.DownloadableSubscription = DownloadableSubscription;
