...
const abpPrefRoot = "extensions.glome.abp.";
...
var abpPrefs = {
  ...
  branch: prefService.getBranch(abpPrefRoot),
  prefList: [],
  listeners: [],
  ...
  init: function() {
    try {
      ...
      var channel = ioService.newChannel("chrome://glome/content/ab/objtabs.css", null, null);
      channel.asyncOpen({
        data: "",
    ...
    strings = stringService.createBundle("chrome://glome/locale/abp-global.properties");
    fixPackageLocale("adblockplus");
    strings = stringService.createBundle("chrome://glome/locale/abp-global.properties");

    // Initialize prefs list
    var defaultBranch = prefService.getDefaultBranch(abpPrefRoot);
...
abpPrefs.addObservers();
glome.abp.prefs = prefs;
